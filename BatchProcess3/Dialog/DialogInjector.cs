...
{
    public static readonly AttachedProperty<bool> AddDialogProperty =
        AvaloniaProperty.RegisterAttached<Control, bool>("AddDialog", typeof(DialogInjector));
    ...
    public static bool GetAddDialog(Control control)
    {
        return control.GetValue(AddDialogProperty);
    }

    public static void SetAddDialog(Control control, bool value)
    {
        control.SetValue(AddDialogProperty, value);
    }
