...
public static class TopLevelLocator
{
    ...
    public static readonly AvaloniaProperty<bool> CaptureProperty =
        AvaloniaProperty.RegisterAttached<Control, bool>("Capture", typeof(TopLevelLocator));
    ...
    {
        return control.GetValue<bool>(CaptureProperty);
    }

    public static void SetCapture(Control control, bool value)
    {
        control.SetValue(CaptureProperty, value);
    }
