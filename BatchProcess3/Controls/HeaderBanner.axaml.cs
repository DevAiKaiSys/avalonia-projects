...
public partial class HeaderBanner : UserControl
{
    public static readonly StyledProperty<IImage?> BackgroundImageProperty =
        AvaloniaProperty.Register<HeaderBanner, IImage?>(
            nameof(BackgroundImage));

    public static readonly StyledProperty<string?> HeaderProperty = AvaloniaProperty.Register<HeaderBanner, string?>(
        nameof(Header));

    public static readonly StyledProperty<string?> SubHeaderAProperty =
        AvaloniaProperty.Register<HeaderBanner, string?>(
            nameof(SubHeaderA));

    public static readonly StyledProperty<string?> SubHeaderBProperty =
        AvaloniaProperty.Register<HeaderBanner, string?>(
            nameof(SubHeaderB));
