...
public partial class ActionsTabFileInfoViewModel : ViewModelBase
{
    ...
    public ActionsTabFileInfoDataModel ToDataModel()
    {
        return new ActionsTabFileInfoDataModel
        {
            Id = Id,
...
{
    public static ActionsTabFileInfoViewModel ToViewModel(this ActionsTabFileInfoDataModel dataModel)
    {
        return new ActionsTabFileInfoViewModel
        {
            Id = dataModel.Id,
